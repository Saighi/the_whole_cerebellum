...
def generate_outside_microzone_connectivity(cere_info,cere_state,microzone_synapses):
    for key in cere_info["synapse_pop"]:
        ...
        if key not in microzone_synapses: 
            weight_matrice,connectivity = gene_connectivity_inclusive(nb_connect,input_pop_size,target_pop_size,mean_weight,minimum_connect)
...
def dense_microzone_connectivity(microzone_size,size_source,size_target,mean_weight,pathway_source=None,pathway_target=None):
...
def generate_microzone_connectivity(cere_info,cere_state):
    ...
    weights_PC_DCN,connectivity_PC_DCN,PC_pathway,DCN_pathway = dense_microzone_connectivity(microzone_size,PC_size,DCN_size,mean_weight_PC_DCN)
    ...
    weights_DCN_IO,connectivity_DCN_IO,_,IO_pathway = dense_microzone_connectivity(microzone_size,DCN_size,IO_size,mean_weight_DCN_IO,pathway_source=DCN_pathway)
    ...
    weights_IO_PC,connectivity_IO_PC,_,_ = dense_microzone_connectivity(microzone_size,IO_size,PC_size,mean_weight_IO_PC,pathway_source=IO_pathway,pathway_target=PC_pathway)
